...
public class DataBaseRoomStepDefinitions {
    ...
    public void connect_to_database() throws SQLException {
        ...
        //1. Adım: Connection oluştur//Host nama/adress medunna.com //port5432//Maintanancedatabase medunna_db_v2
    ...
    public void read_room_and_validate() throws SQLException {
        RoomPojo expectedData = new RoomPojo(roomNumberFaker,"PREMIUM_DELUXE",
                true,123.00,"Created For End To End Test");
